...
addr_out                            
  ...
  wire [2:0] addr_a1;      
  wire [1:0] addr_a0;      
  assign addr_out[2:0] = {addr_a1[0],addr_a1[1],addr_a1[2]};   
  assign addr_out[4:3] = addr_a0[1:0];   
  
  assign addr_a0 = counter_in[4:3]; 
  assign addr_a1 = counter_in[2:0]; 
