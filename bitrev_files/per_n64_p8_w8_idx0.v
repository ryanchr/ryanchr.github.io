...
rst                              
  ...
  assign wire_ctrl_stage0[0] = counter_w[2]; 
  assign wire_ctrl_stage0[1] = counter_w[2]; 
  assign wire_ctrl_stage0[2] = counter_w[2]; 
  assign wire_ctrl_stage0[3] = counter_w[2]; 
  ...
  assign wire_ctrl_stage2[0] = counter_w[0]; 
  assign wire_ctrl_stage2[1] = counter_w[0]; 
  assign wire_ctrl_stage2[2] = counter_w[0]; 
  assign wire_ctrl_stage2[3] = counter_w[0]; 
...
rst                              
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[0]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[2]; 
  end                            
...
addr_out                            
  ...
  wire [2:0] addr_a0;      
  assign addr_out[2:0] = addr_a0[2:0];   
  
  assign addr_a0 = counter_in[2:0]; 
...
rst                              
  ...
  assign mem_addr_out_w_h = mem_addr_out_w[2:0];        
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[2:0] == {3{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {3{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {3{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  dist_ram_sp #(.DATA_WIDTH(8), .ADDR_WIDTH(3)) 
