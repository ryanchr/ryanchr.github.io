...
rst                              
  ...
  assign wire_ctrl_stage0[1] = counter_w[4]; 
  assign wire_ctrl_stage0[2] = counter_w[4]; 
  assign wire_ctrl_stage0[3] = counter_w[4]; 
  ...
  assign wire_ctrl_stage1[0] = counter_w[3]; 
  assign wire_ctrl_stage1[1] = counter_w[3]; 
  assign wire_ctrl_stage1[2] = counter_w[3]; 
  assign wire_ctrl_stage1[3] = counter_w[3]; 
...
rst                              
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[3]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[4]; 
  end                            
...
addr_out                            
  ...
  assign addr_out[4:2] = addr_a0[2:0];   
  
  assign addr_a0 = counter_in[4:2]; 
...
rst                              
  ...
  output [4:0] mem_addr_out_2;            
  output [4:0] mem_addr_out_3;            
  output [4:0] mem_addr_out_4;            
  output [4:0] mem_addr_out_5;            
  output [4:0] mem_addr_out_6;            
  output [4:0] mem_addr_out_7;            
  output wen_out;
  ...
  wire [4:0] mem_addr_out_tmp_2;   
  wire [4:0] mem_addr_out_tmp_3;   
  wire [4:0] mem_addr_out_tmp_4;   
  wire [4:0] mem_addr_out_tmp_5;   
  wire [4:0] mem_addr_out_tmp_6;   
  wire [4:0] mem_addr_out_tmp_7;   
  ...
  assign mem_addr_out_w_h = mem_addr_out_w[4:2];        
...
rst                              
  ...
  dist_ram_sp #(.DATA_WIDTH(16), .ADDR_WIDTH(5)) 
