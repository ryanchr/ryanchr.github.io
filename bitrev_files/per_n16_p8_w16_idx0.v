...
rst                              
  ...
  assign wireOut[1] = wireIn[1]; assign wireOut[0]= wireIn[0]; assign wireOut[2] = wireIn[3]; assign wireOut[3]= wireIn[2]; assign wireOut[5] = wireIn[5]; assign wireOut[4]= wireIn[4]; assign wireOut[6] = wireIn[7]; assign wireOut[7]= wireIn[6]; 
  assign outData_0 = wireOut[0];    
  assign outData_1 = wireOut[1];    
  assign outData_2 = wireOut[2];    
  assign outData_3 = wireOut[3];    
...
rst                              
  ...
  assign wire_ctrl_stage0[0] = counter_w[0]; 
  assign wire_ctrl_stage0[1] = counter_w[0]; 
  assign wire_ctrl_stage0[2] = counter_w[0]; 
  assign wire_ctrl_stage0[3] = counter_w[0]; 
  ...
  assign wire_ctrl_stage1[0] = counter_w[-1]; 
  assign wire_ctrl_stage1[1] = counter_w[-1]; 
  assign wire_ctrl_stage1[2] = counter_w[-1]; 
  assign wire_ctrl_stage1[3] = counter_w[-1]; 
  ...
  assign wire_ctrl_stage2[0] = counter_w[-2]; 
  assign wire_ctrl_stage2[1] = counter_w[-2]; 
  assign wire_ctrl_stage2[2] = counter_w[-2]; 
  assign wire_ctrl_stage2[3] = counter_w[-2]; 
...
rst                              
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[-2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[-2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[-2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[-2]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[-1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[-1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[-1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[-1]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[0]; 
  end                            
...
module  mem_addr_gen_dp8_mem0_per0(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  wire [0:0] addr_a0;      
  assign addr_out[0:0] = addr_a0[0:0];   
  
  assign addr_a0 = counter_in[0:0]; 
  
endmodule                        


module  mem_addr_ctrl_dp8_per0(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  input in_start, clk, rst;                   
  input [0:0] counter_in; 
  output [0:0] mem_addr_out_0;            
  output [0:0] mem_addr_out_1;            
  output [0:0] mem_addr_out_2;            
  output [0:0] mem_addr_out_3;            
  output [0:0] mem_addr_out_4;            
  output [0:0] mem_addr_out_5;            
  output [0:0] mem_addr_out_6;            
  output [0:0] mem_addr_out_7;            
  output wen_out;
  ...
  wire [0:0] mem_addr_out_tmp_0;   
  wire [0:0] mem_addr_out_tmp_1;   
  wire [0:0] mem_addr_out_tmp_2;   
  wire [0:0] mem_addr_out_tmp_3;   
  wire [0:0] mem_addr_out_tmp_4;   
  wire [0:0] mem_addr_out_tmp_5;   
  wire [0:0] mem_addr_out_tmp_6;   
  wire [0:0] mem_addr_out_tmp_7;   
  wire [0:0] mem_addr_out_w;        
  wire [2:0] mem_addr_out_w_h;        
  
  mem_addr_gen_dp8_mem0_per0 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[0:-2];        
  assign mem_addr_out_tmp_0 = {mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_1 = {mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_2 = {mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_3 = {mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_4 = {~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_5 = {~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_6 = {~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_7 = {~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[0:0] == {1{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {1{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {1{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  wire [0:0] addr_wire_4;        

  wire [0:0] addr_wire_5;        

  wire [0:0] addr_wire_6;        

  wire [0:0] addr_wire_7;        

  mem_addr_ctrl_dp8_per0 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));

  dist_ram_sp #(.DATA_WIDTH(16), .ADDR_WIDTH(1)) 
...
rst                              
  ...
  mem_stage_dp8_r mem_stage_dp8_r_inst(.inData_0(wireOut_LB[0]), .inData_1(wireOut_LB[1]), .inData_2(wireOut_LB[2]), .inData_3(wireOut_LB[3]), .inData_4(wireOut_LB[4]), .inData_5(wireOut_LB[5]), .inData_6(wireOut_LB[6]), .inData_7(wireOut_LB[7]), .outData_0(wireIn_RB[0]), .outData_1(wireIn_RB[1]), .outData_2(wireIn_RB[2]), .outData_3(wireIn_RB[3]), .outData_4(wireIn_RB[4]), .outData_5(wireIn_RB[5]), .outData_6(wireIn_RB[6]), .outData_7(wireIn_RB[7]), .in_start(out_start_LB), .out_start(out_start_MemStage), .clk(clk), 
