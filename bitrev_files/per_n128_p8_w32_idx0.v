...
rst                              
  ...
  assign wire_ctrl_stage0[0] = counter_w[3]; 
  assign wire_ctrl_stage0[1] = counter_w[3]; 
  assign wire_ctrl_stage0[2] = counter_w[3]; 
  assign wire_ctrl_stage0[3] = counter_w[3]; 
  ...
  assign wire_ctrl_stage1[0] = counter_w[2]; 
  assign wire_ctrl_stage1[1] = counter_w[2]; 
  assign wire_ctrl_stage1[2] = counter_w[2]; 
  assign wire_ctrl_stage1[3] = counter_w[2]; 
  ...
  assign wire_ctrl_stage2[0] = counter_w[1]; 
  assign wire_ctrl_stage2[1] = counter_w[1]; 
  assign wire_ctrl_stage2[2] = counter_w[1]; 
  assign wire_ctrl_stage2[3] = counter_w[1]; 
...
rst                              
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[1]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[2]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[3]; 
  end                            
...
addr_out                            
  ...
  wire [0:0] addr_a1;      
  wire [2:0] addr_a0;      
  assign addr_out[0:0] = {addr_a1[0]};   
  assign addr_out[3:1] = addr_a0[2:0];   
  
  assign addr_a0 = counter_in[3:1]; 
...
rst                              
  ...
  input in_start, clk, rst;                   
  input [3:0] counter_in; 
  output [3:0] mem_addr_out_0;            
  output [3:0] mem_addr_out_1;            
  output [3:0] mem_addr_out_2;            
  output [3:0] mem_addr_out_3;            
  output [3:0] mem_addr_out_4;            
  output [3:0] mem_addr_out_5;            
  output [3:0] mem_addr_out_6;            
  output [3:0] mem_addr_out_7;            
  output wen_out;
  ...
  wire [3:0] mem_addr_out_tmp_0;   
  wire [3:0] mem_addr_out_tmp_1;   
  wire [3:0] mem_addr_out_tmp_2;   
  wire [3:0] mem_addr_out_tmp_3;   
  wire [3:0] mem_addr_out_tmp_4;   
  wire [3:0] mem_addr_out_tmp_5;   
  wire [3:0] mem_addr_out_tmp_6;   
  wire [3:0] mem_addr_out_tmp_7;   
  wire [3:0] mem_addr_out_w;        
  wire [2:0] mem_addr_out_w_h;        
  wire [0:0] mem_addr_out_w_l;        
  
  mem_addr_gen_dp8_mem0_per0 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[3:1];        
  assign mem_addr_out_w_l = mem_addr_out_w[0:0];   
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[3:0] == {4{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {4{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {4{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  wire [3:0] addr_wire_2;        

  wire [3:0] addr_wire_3;        

  wire [3:0] addr_wire_4;        

  wire [3:0] addr_wire_5;        

  wire [3:0] addr_wire_6;        

  wire [3:0] addr_wire_7;        
  ...
  dist_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(4)) 
