...
addr_out                            
  ...
  assign addr_out[4:4] = {addr_a1[0]};   
  assign addr_out[5:5] = addr_a0[0:0];   
  
  assign word_counter_w[0] = counter_in[4:1];  
  assign addr_a0 = counter_in[5:5]; 
...
rst                              
  ...
  dist_ram_sp #(.DATA_WIDTH(8), .ADDR_WIDTH(6)) 
