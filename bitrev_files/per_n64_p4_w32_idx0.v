...
module  mem_addr_gen_dp4_mem0_per0(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[3:2] = addr_a0[1:0];   
  
  assign addr_a0 = counter_in[3:2]; 
  assign addr_a1 = counter_in[1:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp4_per0(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  assign mem_addr_out_w_h = mem_addr_out_w[3:2];        
